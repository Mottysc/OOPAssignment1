...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        Room splitRoad = new Room("the Road", "The road is at a split. You can walk north to go to your house, east to get to your grandma's house or your neighbour's house, or you can go west to the shop.", 'S', new Position(2, 4));
        map.placeRoom(splitRoad.getPosition(), splitRoad.getSymbol());
        Room eastMidRoad = new Room("the Road", "", 'N', new Position(3, 4));
