...
public class Inventory {
    ...
    //Descriptions can be read using "look <item>", but not all items need them, so there are two addItem attributes
    ...
    public void removeItem(String item) {
        boolean found = false;
        //Cycle through the items, if the item was just found, move the current item back (to overwrite it), and then move that forward
